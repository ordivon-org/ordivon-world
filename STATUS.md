...
| W5-A Agent Embodiment | active research; A0/A1 falsifier verified | one real Game departure accepted two conflicting opaque continuity subjects under current production contracts; an experimental separate continuity-owner receipt rejected payload, destination and Entity substitution without World minting subject identity; active destination embodiment and current Presence remain unproven, so no production contract was added |
...
- Entity Migration materializes a continuity carrier; it does not yet prove that a continuity subject was activated through that carrier or is currently Present.
