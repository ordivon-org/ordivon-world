...
| W1 durable cross-World Resource Transfer and Entity Migration | experimental, locally verified through P1 failure injection | real Game evidence, Host restart, UNKNOWN no-redispatch, Link rebinding, Security SampleVault reconstruction and Windows KVM destination materialization; modules remain non-exported |
