...
| W5-D Interaction | active research; D0 classification verified | Resource, Message and Entity share private `_HostTrajectoryJournal` durability mechanics but retain materially different source/destination semantics: Resource source occurrence is single-transfer, Message Fact can fan out, Entity binds continuity/body materialization. Cloudflare direct effects prove the three transfer families do not exhaust Interaction. No GenericInteraction/UniversalWorldTrajectory is justified; D1 tests composition and partial completion without semantic/authority promotion |
