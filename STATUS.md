...
| W1 durable cross-World Resource Transfer, Entity Migration and Message Delivery | experimental, locally verified through P2 | real Game evidence, Host restart, UNKNOWN no-redispatch, Link rebinding, Security SampleVault/KVM materialization, and durable Message delivery without knowledge promotion; modules remain non-exported |
